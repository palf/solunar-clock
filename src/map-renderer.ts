...
import { GeoCoordinates, GeoFeature, GeoFeatureCollection, TopoJSONData } from './types';
...
export class MapRenderer {
  ...
  private renderFallbackOutline(): void {
    ...
    const worldOutline: GeoCoordinates[] = [
      [-180, -60], [-180, 80], [-120, 80], [-60, 80], [0, 80], [60, 80], [120, 80], [180, 80],
      [180, 60], [180, 0], [180, -60], [120, -60], [60, -60], [0, -60], [-60, -60], [-120, -60], [-180, -60]
    ];
    ...
    try {
      ...
      // Try to find any geometry object
        ...
        if (geometryKey) {
          ...
          const geometry = topojson.feature(mapData, mapData.objects[geometryKey]!) as GeoFeatureCollection;
